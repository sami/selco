...
const FOOTER = `<footer class="tmc-footer"> <div class="tmc-footer-inner"> <p><strong>Trade Materials Calculator</strong>: estimating tools for trade sales assistants.</p> <p>Every figure is an estimate, not an exact quantity, so check it with the customer before anything's ordered. This is an independent project, not affiliated with or endorsed by any builders' merchant or manufacturer, and product names belong to their owners.</p> </div> </footer>`;
